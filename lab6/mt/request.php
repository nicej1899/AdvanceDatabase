...
*/
$bd = 'localhost/CNDB';
$connection = OCI_connect('ora00069', 'VbMyxJ', $bd);
if(!$connection) 
        {
...
$curs1 = OCI_parse($connection, "SELECT component_id FROM ora00097.component where part_id = $id");
