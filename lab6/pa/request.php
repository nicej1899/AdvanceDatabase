...
*/
$bd = 'localhost/CNDB';
$connection = OCI_connect('ora00152', 'd5pQc3', $bd);
if(!$connection) 
        {
...
$curs1 = OCI_parse($connection, "SELECT product.supplier_id, product.product_id, unit, unit_price FROM ora00097.product, ora00097.pot_supplier where $part_id = pot_supplier.part_id and pot_supplier.product_id = product.product_id");
...
while (OCI_fetch($curs1))
		$chain .= "$supplier_id  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp $product_id&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  $unit&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp $unit_price<br>\n";
